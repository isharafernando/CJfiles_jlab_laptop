...
Long_t MUSEteleTracker::startup()
{
  ...
  // create output branch with tracks:
	...
	printf(" teletracks %p\n", teletracks);
	//printf("This is a test printf statement\n");
...
{
	event=event+1;
    //printf("start a new good event %d \n",event);
  ...
  // char leftright[2][18] = {"downstream", "upstream"};
	...
	if ((gemmulti[0]>=1)&&(gemmulti[1]>=1)&&(gemmulti[2]>=1)){
		totaltracks++;
	}
	
	if (((gemmulti[0]==0)&&(gemmulti[1]>=1)&&(gemmulti[2]>=1))||((gemmulti[0]==0)&&(gemmulti[1]==0)&&(gemmulti[2]>=1))||((gemmulti[0]==0)&&(gemmulti[1]>=1)&&(gemmulti[2]==0))){
		falsetracksUS=falsetracksUS+1;
	}
	
	if (((gemmulti[0]>=1)&&(gemmulti[1]==0)&&(gemmulti[2]>=1))||((gemmulti[0]==0)&&(gemmulti[1]==0)&&(gemmulti[2]>=1))||((gemmulti[0]>=1)&&(gemmulti[1]==0)&&(gemmulti[2]==0))){
		falsetracks4th=falsetracks4th+1;
	}


	if (((gemmulti[0]>=1)&&(gemmulti[1]>=1)&&(gemmulti[2]==0))||((gemmulti[0]>=1)&&(gemmulti[1]==0)&&(gemmulti[2]==0))||((gemmulti[0]==0)&&(gemmulti[1]>=1)&&(gemmulti[2]==0))){
		falsetracksMS=falsetracksMS+1;
	}
       ...
       //Here we are saving all the clusters on each GEM
       H1(gemmulti[0], Form("MUSEteleTracker/All clusters US"), Form("Total number of clusters - US GEM"),
       	11,-0.5,10.5);
       H1(gemmulti[1], Form("MUSEteleTracker/All clusters 4TH"), Form("Total number of clusters - 4TH GEM"),
       	11,-0.5,10.5);
       H1(gemmulti[2], Form("MUSEteleTracker/All clusters MI"), Form("Total number of clusters - MI GEM"),
       	11,-0.5,10.5);
       H1(gemmulti[3], Form("MUSEteleTracker/All clusters DS"), Form("Total number of clusters - DS GEM"),
       	11,-0.5,10.5);
...
//ETHAN
  ...
  Long_t MUSEteleTracker::finalize()
  {
	...
	printf("total complete tracks (clusters on all three GEMs) = %d \n",totaltracks);
	truetracksUS=totaltracks-falsetracksUS;
	truetracks4th=totaltracks-falsetracks4th;
	truetracksMS=totaltracks-falsetracksMS;
	printf("Missing US tracks = %d \n",falsetracksUS);
	printf("Missing 4th tracks = %d \n",falsetracks4th);
	printf("Missing MS tracks = %d \n",falsetracksMS);

	//pre_overall_eff=totaltracks/event;
        //printf("Overall GEM efficiency %d \n",pre_overall_eff);

	/*
	pre_eff_US=truetracksUS/totaltracks*100;
	pre_eff_4TH=truetracks4th/totaltracks*100;
	pre_eff_MS=truetracksMS/totaltracks*100;

	printf("US efficiency is : %f% \n",pre_eff_US);
	printf("4th efficiency is : %f% \n",pre_eff_4th);
	printf("MS efficiency is : %f% \n",pre_eff_MS);
	*/
