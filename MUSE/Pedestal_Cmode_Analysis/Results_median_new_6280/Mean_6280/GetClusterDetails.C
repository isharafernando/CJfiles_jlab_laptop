...
void GetClusterDetails()
{
    ...
    TFile *file1 = new TFile(Form("/home/ishara/MUSE/cookedfiles/cookedGEMrun0%d_mean.root",6280));
    ...
    C1->SaveAs("Mean_Method_ClusterInfo_US_x.pdf");
   ...
   TCanvas *C2 = new TCanvas("C2",Form("ADC values of y"), 3000,2000);
    ...
    C2->SaveAs("Mean_Method_ClusterInfo_US_y.pdf");	
   ...
   TCanvas *C3 = new TCanvas("C3",Form("ADC values of x after cmode subtraction"), 3000,2000);
    ...
    C3->SaveAs("Mean_Method_ClusterInfo_US_x_cmode.pdf");	
   ...
   TCanvas *C4 = new TCanvas("C4",Form("ADC values of y after cmode subtraction"), 3000,2000);
    ...
    C4->SaveAs("Mean_Method_ClusterInfo_US_y_cmode.pdf");	
   ...
   TCanvas *C5 = new TCanvas("C5",Form("ADC values of x after pedestal subtraction"), 3000,2000);
    ...
    C5->SaveAs("Mean_Method_ClusterInfo_US_x_pedestal.pdf");	
   ...
   TCanvas *C6 = new TCanvas("C6",Form("ADC values of y after pedestal subtraction"), 3000,2000);
    ...
    C6->SaveAs("Mean_Method_ClusterInfo_US_y_pedestal.pdf");		
    ...
    C7->SaveAs("Mean_Method_US_x_ped_cmode.pdf");
    ...
    C8->SaveAs("Mean_Method_US_y_ped_cmode.pdf");
    ...
    HITMAP->Draw("colz");
    C9->SaveAs("Mean_Method_US_hitmap.pdf");
...
/*
    ...
    C10->SaveAs("Mean_Method_ADCwieghtedPedCmodeX_US.pdf");
    ...
    C11->SaveAs("Mean_Method_ADCwieghtedPedCmodeY_US.pdf");
...
*/
    ...
    ADC1DPedCmodeX->Draw("colz");
    C12->SaveAs("Mean_Method_1D_ADC_Ped_CmodeX_US.pdf");
    ...
    gStyle->SetOptFit(0111);
    C13->SaveAs("Mean_Method_1D_ADC_PedX_US.pdf");
