...
void GetClusterDetails()
{
    ...
    TFile *file1 = new TFile(Form("/home/ishara/MUSE/cookedfiles/cookedGEMrun0%d_median.root",6233));
   ...
   TCanvas *C4 = new TCanvas("C4",Form("ADC values of y after cmode subtraction"), 3000,2000);
    ...
    C4->SaveAs("Median_Method_ClusterInfo_US_y_cmode.pdf");	
   ...
   TCanvas *C5 = new TCanvas("C5",Form("ADC values of x after pedestal subtraction"), 3000,2000);
    ...
    C5->SaveAs("Median_Method_ClusterInfo_US_x_pedestal.pdf");	
   ...
   TCanvas *C6 = new TCanvas("C6",Form("ADC values of y after pedestal subtraction"), 3000,2000);
    ...
    C6->SaveAs("Median_Method_ClusterInfo_US_y_pedestal.pdf");		
    ...
    C7->SaveAs("Median_Method_US_x_ped_cmode.pdf");
    ...
    C8->SaveAs("Median_Method_US_y_ped_cmode.pdf");
    ...
    HITMAP->Draw("colz");
    C9->SaveAs("Median_Method_US_hitmap.pdf");

/*
    TCanvas *C10 = new TCanvas("C10",Form("1D Cmode X"), 3000,2000);
    C10->cd(10);
...
*/
    ...
    ADC1DPedCmodeX->Draw("colz");
    C12->SaveAs("Median_Method_1D_ADC_Ped_CmodeX_US.pdf");
    ...
    gStyle->SetOptFit(0111);
    C13->SaveAs("Median_Method_1D_ADC_PedX_US.pdf");
