...
void GetClusterDetails(int run_num)
{
    ...
    C1->SaveAs("Median_Michael_v_ClusterInfo_US_x.pdf");
   ...
   TCanvas *C2 = new TCanvas("C2",Form("ADC values of y"), 3000,2000);
    ...
    C2->SaveAs("Median_Michael_v_ClusterInfo_US_y.pdf");	
   ...
   TCanvas *C3 = new TCanvas("C3",Form("ADC values of x after cmode subtraction"), 3000,2000);
    ...
    C3->SaveAs("Median_Michael_v_ClusterInfo_US_x_cmode.pdf");	
   ...
   TCanvas *C4 = new TCanvas("C4",Form("ADC values of y after cmode subtraction"), 3000,2000);
    ...
    C4->SaveAs("Median_Michael_v_ClusterInfo_US_y_cmode.pdf");	
   ...
   TCanvas *C5 = new TCanvas("C5",Form("ADC values of x after pedestal subtraction"), 3000,2000);
    ...
    C5->SaveAs("Median_Michael_v_ClusterInfo_US_x_pedestal.pdf");	
   ...
   TCanvas *C6 = new TCanvas("C6",Form("ADC values of y after pedestal subtraction"), 3000,2000);
    ...
    C6->SaveAs("Median_Michael_v_ClusterInfo_US_y_pedestal.pdf");		
    ...
    C7->SaveAs("Median_Michael_v_US_x_ped_cmode.pdf");
    ...
    C8->SaveAs("Median_Michael_v_US_y_ped_cmode.pdf");
    ...
    HITMAP->Draw("colz");
    C9->SaveAs("Median_Michael_v_US_hitmap.pdf");
