  ...
  if(BHPlaneCount[2]==1 and BHPlaneCount[3]==1)
  {
    ...
    {   
      ...
      if((fabs(dx)>5.0) and (fabs(dy)>5.0) and (fabs(xe[gem0])>50.0) and (fabs(ye[gem0])>50.0))
      {
       ...
       H2(xe[gem0],Plane2crds[0], Form("Efficiency/%s/BHPlane2_corr_X_GEM_%s", gemdet,gemdet), Form("X correlation of BH Plane 2  and %s GEM", gemdet),50,-50.0,50.0,50,-50.0,50.0);
       
       H2(xe[gem0],Plane2crds[1], Form("Efficiency/%s/BHPlane2_corr_XY_GEM_%s", gemdet,gemdet), Form("Y-X correlation of BH Plane 2  and %s GEM", gemdet),50,-50.0,50.0,50,-50.0,50.0);
       
       H2(xe[gem0],Plane3crds[0], Form("Efficiency/%s/BHPlane3_corr_X_GEM_%s", gemdet,gemdet), Form("X correlation of BH Plane 3  and %s GEM", gemdet),50,-50.0,50.0,50,-50.0,50.0);
       
       H2(xe[gem0],Plane3crds[1], Form("Efficiency/%s/BHPlane3_corr_XY_GEM_%s", gemdet,gemdet), Form("Y-X correlation of BH Plane 3  and %s GEM", gemdet),50,-50.0,50.0,50,-50.0,50.0);
       

       H2(ye[gem0],Plane2crds[0], Form("Efficiency/%s/BHPlane2_corr_YX_GEM_%s", gemdet,gemdet), Form("X-Y correlation of BH Plane 2  and %s GEM", gemdet),50,-50.0,50.0,50,-50.0,50.0);
       
       H2(ye[gem0],Plane2crds[1], Form("Efficiency/%s/BHPlane2_corr_Y_GEM_%s", gemdet,gemdet), Form("Y correlation of BH Plane 2  and %s GEM", gemdet),50,-50.0,50.0,50,-50.0,50.0);
       
       H2(ye[gem0],Plane3crds[0], Form("Efficiency/%s/BHPlane3_corr_YX_GEM_%s", gemdet,gemdet), Form("X-Y correlation of BH Plane 3  and %s GEM", gemdet),50,-50.0,50.0,50,-50.0,50.0);
       
       H2(ye[gem0],Plane3crds[1], Form("Efficiency/%s/BHPlane3_corr_Y_GEM_%s", gemdet,gemdet), Form("Y correlation of BH Plane 3  and %s GEM", gemdet),50,-50.0,50.0,50,-50.0,50.0);
