...
Long_t MUSEteleTracker::process_efficiency()
{
    ...
    for(size_t i = 0; i < Hits->hits.size(); i++)
    {
        ...
        { 
          ...
          H1(Plane2crds[0], Form("Efficiency/BH_Plane2_x_positions"), Form("Cluster x positions of BH Plane 2"),50,-50.0,50.0);
          H1(Plane2crds[1], Form("Efficiency/BH_Plane2_y_positions"), Form("Cluster y positions of BH Plane 2"),50,-50.0,50.0);
          H1(Plane2crds[2], Form("Efficiency/BH_Plane2_z_positions"), Form("Cluster z positions of BH Plane 2"),50,-650.0,-600.0);
          H1(bar, Form("Efficiency/BH_Plane2_bar_number"), Form("Bar number of BH Plane 2"),15,-0.5,14.5);
          BHPlaneCount[plane]++;
        }; 
       ...
       if(plane==3)
        { 
          ...
          Plane3crds[2] = mas[2]*10;
           H1(Plane3crds[0], Form("Efficiency/BH_Plane3_x_positions"), Form("Cluster x positions of BH Plane 3"),50,-50.0,50.0);
           H1(Plane3crds[1], Form("Efficiency/BH_Plane3_y_positions"), Form("Cluster y positions of BH Plane 3"),50,-50.0,50.0);
           H1(Plane3crds[2], Form("Efficiency/BH_Plane3_z_positions"), Form("Cluster z positions of BH Plane 3"),50,-650.0,600.0);
           H1(bar, Form("Efficiency/BH_Plane3_bar_number"), Form("Bar number of BH Plane 3"),15,-0.5,14.5);
          BHPlaneCount[plane]++;
        };      
  ...
  H1(BHPlaneCount[2], Form("Efficiency/BH_Plane2_Cluster_Multiplicity"), Form("Cluster Multiplicity of BH Plane 2"),
       11,-0.5,10.5);

  H1(BHPlaneCount[3], Form("Efficiency/BH_Plane3_Cluster_Multiplicity"), Form("Cluster Multiplicity of BH Plane 3"),
       11,-0.5,10.5);
  ...
  if(BHPlaneCount[2]==1 and BHPlaneCount[3]==1)
  {
    ...
    for(size_t i = 0; i < Hits->hits.size(); i++)
    {
        ...
        { 
          Plane2AC=plane;
          Plane2barAC = bar;
          Plane2crdsAC[0] = BHhitxyz[i][0];
          Plane2crdsAC[1] = BHhitxyz[i][1];
          Plane2crdsAC[2] = BHhitxyz[i][2];
          H1(Plane2crdsAC[0], Form("Efficiency/BH_Plane2_1hit_x_positions"), Form("Cluster x positions of BH Plane 2 1hit"),50,-50.0,50.0);
          H1(Plane2crdsAC[1], Form("Efficiency/BH_Plane2_1hit_y_positions"), Form("Cluster y positions of BH Plane 2 1hit"),50,-50.0,50.0);
          H1(Plane2crdsAC[2], Form("Efficiency/BH_Plane2_1hit_z_positions"), Form("Cluster z positions of BH Plane 2 1hit"),50,-650.0,-600.0);
          H1(Plane2barAC, Form("Efficiency/BH_Plane2_1hit_bar_number"), Form("Bar number of BH Plane 2 1hit"),15,-0.5,14.5);
       ...
       if(plane==3)
        { 
          Plane3AC=plane;
          Plane3barAC = bar;
          Plane3crdsAC[0] = BHhitxyz[i][0];
          Plane3crdsAC[1] = BHhitxyz[i][1];
          Plane3crdsAC[2] = BHhitxyz[i][2];
          H1(Plane3crdsAC[0], Form("Efficiency/BH_Plane3_1hit_x_positions"), Form("Cluster x positions of BH Plane 3 1hit"),50,-50.0,50.0);
          H1(Plane3crdsAC[1], Form("Efficiency/BH_Plane3_1hit_y_positions"), Form("Cluster y positions of BH Plane 3 1hit"),50,-50.0,50.0);
          H1(Plane3crdsAC[2], Form("Efficiency/BH_Plane3_1hit_z_positions"), Form("Cluster z positions of BH Plane 3 1hit"),50,-650.0,-600.0);
          H1(Plane3barAC, Form("Efficiency/BH_Plane3_1hit_bar_number"), Form("Bar number of BH Plane 3 1hit"),15,-0.5,14.5);
          BHPlaneCountAC[plane]++;
    ...
    //printf("(%d,%d)",BHPlaneCountAC[2],BHPlaneCountAC[3]);

    H1(BHPlaneCountAC[2], Form("Efficiency/BH_Plane2_1Hitluster_Multiplicity"), Form("Cluster Multiplicity of BH Plane 2 with 1 hit"),
       11,-0.5,10.5);

    H1(BHPlaneCountAC[3], Form("Efficiency/BH_Plane3_1Hit_Cluster_Multiplicity"), Form("Cluster Multiplicity of BH Plane 3 with 1 hit"),
       11,-0.5,10.5);
    ...
    {   
      ...
      //BH GEM cross correlation

       H2(BHplane2X,Plane2crds[0], Form("Efficiency/%s/BHPlane2_corr_X%s", gemdet,gemdet), Form("Correlation of BH Plane 2: ProjectedX vs ActualX: %s GEM", gemdet),50,-50.0,50.0,50,-50.0,50.0);
       
       H2(BHplane2X,Plane2crds[1], Form("Efficiency/%s/BHPlane2_corr_XY%s", gemdet,gemdet), Form("Correlation of BH Plane 2 : ProjectedX vs ActualY: %s GEM", gemdet),50,-50.0,50.0,50,-50.0,50.0);

       H2(BHplane2Y,Plane2crds[0], Form("Efficiency/%s/BHPlane2_corr_YX%s", gemdet,gemdet), Form("Correlation of BH Plane 2 X : ProjectedY vs ActualX: %s GEM", gemdet),50,-50.0,50.0,50,-50.0,50.0);
       
       H2(BHplane2Y,Plane2crds[1], Form("Efficiency/%s/BHPlane2_corr_Y%s", gemdet,gemdet), Form("Correlation of BH Plane 2 Y  : ProjectedY vs ActualY: %s GEM", gemdet),50,-50.0,50.0,50,-50.0,50.0);
  

       
       H2(BHplane3X,Plane3crds[0], Form("Efficiency/%s/BHPlane3_corr_X%s", gemdet,gemdet), Form("Correlation of BH Plane 3 X : ProjectedX vs ActualX: %s GEM", gemdet),50,-50.0,50.0,50,-50.0,50.0);
       
       H2(BHplane3X,Plane3crds[1], Form("Efficiency/%s/BHPlane3_corr_XY%s", gemdet,gemdet), Form("Correlation of BH Plane 3 Y : ProjectedX vs ActualY: %s GEM", gemdet),50,-50.0,50.0,50,-50.0,50.0);
            
       H2(BHplane3Y,Plane3crds[0], Form("Efficiency/%s/BHPlane3_corr_YX%s", gemdet,gemdet), Form("Correlation of BH Plane 3 X : ProjectedY vs ActualX: %s GEM", gemdet),50,-50.0,50.0,50,-50.0,50.0);
       
       H2(BHplane3Y,Plane3crds[1], Form("Efficiency/%s/BHPlane3_corr_Y%s", gemdet,gemdet), Form("Correlation of BH Plane 3 Y : ProjectedY vs ActualY: %s GEM", gemdet),50,-50.0,50.0,50,-50.0,50.0);
       ...
       H2(xe[gem0],Plane2crds[0], Form("Efficiency/%s/BHPlane2_corr_X_GEM_%s", gemdet,gemdet), Form("Correlation of BH Plane 2 X  Vs %s GEM X", gemdet),200,-50.0,50.0,200,-50.0,50.0);
       
       H2(xe[gem0],Plane2crds[1], Form("Efficiency/%s/BHPlane2_corr_XY_GEM_%s", gemdet,gemdet), Form("Correlation of BH Plane 2 Y and %s GEM X", gemdet),2000,-50.0,50.0,200,-50.0,50.0);
       
       H2(xe[gem0],Plane3crds[0], Form("Efficiency/%s/BHPlane3_corr_X_GEM_%s", gemdet,gemdet), Form("Correlation of BH Plane 3 X and %s GEM X", gemdet),200,-50.0,50.0,200,-50.0,50.0);
       
       H2(xe[gem0],Plane3crds[1], Form("Efficiency/%s/BHPlane3_corr_XY_GEM_%s", gemdet,gemdet), Form("Correlation of BH Plane 3 Y and %s GEM X", gemdet),200,-50.0,50.0,200,-50.0,50.0);
       

       H2(ye[gem0],Plane2crds[0], Form("Efficiency/%s/BHPlane2_corr_YX_GEM_%s", gemdet,gemdet), Form("Correlation of BH Plane 2 X and %s GEM Y", gemdet),200,-50.0,50.0,200,-50.0,50.0);
       
       H2(ye[gem0],Plane2crds[1], Form("Efficiency/%s/BHPlane2_corr_Y_GEM_%s", gemdet,gemdet), Form("Correlation of BH Plane 2 Y  and %s GEM Y", gemdet),200,-50.0,50.0,200,-50.0,50.0);
       
       H2(ye[gem0],Plane3crds[0], Form("Efficiency/%s/BHPlane3_corr_YX_GEM_%s", gemdet,gemdet), Form("Correlation of BH Plane 3 X and %s GEM Y", gemdet),200,-50.0,50.0,200,-50.0,50.0);
       
       H2(ye[gem0],Plane3crds[1], Form("Efficiency/%s/BHPlane3_corr_Y_GEM_%s", gemdet,gemdet), Form("Correlation of BH Plane 3 Y and %s GEM Y", gemdet),200,-50.0,50.0,200,-50.0,50.0);
