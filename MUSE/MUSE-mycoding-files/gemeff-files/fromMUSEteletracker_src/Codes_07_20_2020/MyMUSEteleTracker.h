...
//TH1D *trackmultiplicityUS,*trackmultiplicityMS,*trackmultiplicity4TH, *trackmultiplicityDS;

//TH1D *xresidual;
//TH1D *yresidual;
//TH1D *USX_eff,*FthX_eff,*MSX_eff;
//TH1D *USY_eff,*FthY_eff,*MSY_eff;

//TH1D *tracksprojectedgemUSX_onecut,*tracksprojectedgemUSX_any;
//TH1D *tracksprojectedgem4THX_onecut,*tracksprojectedgem4THX_any;
//TH1D *tracksprojectedgemMSX_onecut,*tracksprojectedgemMSX_any;

//TH1D *tracksprojectedgemUSY_onecut,*tracksprojectedgemUSY_any;
//TH1D *tracksprojectedgem4THY_onecut,*tracksprojectedgem4THY_any;
