...
Long_t MUSEteleTracker::process_GEMBH_efficiency()
{
    ...
    for(size_t i = 0; i < Hits->hits.size(); i++)
    {
      ...
      if(Intime_hits==1){
        ...
        if(BHPlaneCt[0]==1 and BHPlaneCt[1]==1 and BHPlaneCt[2]==1 and BHPlaneCt[1]==1){ 
        int plane = Hits->hits[i].wall_id;
        int bar = Hits->hits[i].bar_id;
        ...
        { 
          ...
          H1(Plane0crds[2], Form("GEMBHEfficiency/BH/Plane0/BH_Plane0_z_positions"), Form("Cluster z positions of BH Plane 0"),50,-625.0,-575.0);
        ...
        { 
          ...
          H1(Plane1crds[2], Form("GEMBHEfficiency/BH/Plane1/BH_Plane1_z_positions"), Form("Cluster z positions of BH Plane 1"),50,-600.0,-550.0);
    ...
    for(size_t i = 0; i < Hits->hits.size(); i++)
    {
      ...
      if(Intime_hits==1){
        ...
        { 
          ...
          H1(Plane0crdsAC[2], Form("GEMBHEfficiency/BH/Plane0/BH_Plane0_1hit_z_positions"), Form("Cluster z positions of BH Plane 0 1hit"),50,-625.0,-575.0);
        ...
        { 
          ...
          H1(Plane1crdsAC[2], Form("GEMBHEfficiency/BH/Plane1/BH_Plane1_1hit_z_positions"), Form("Cluster z positions of BH Plane 1 1hit"),50,-600.0,-550.0);
