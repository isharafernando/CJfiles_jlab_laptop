...
Long_t MUSEteleTracker::process_efficiency()
{
  ...
  if(BHPlaneCount[2]==1 and BHPlaneCount[3]==1)
  {
    ...
    {   
      ...
      if ((fabs(xg[gemID[0]])>50.0)and(fabs(yg[gemID[0]])>50.0)and(fabs(xg[gemID[1]])>50.0)and(fabs(yg[gemID[1]])>50.0)) continue;
      ...
      if((fabs(BHdx)>4.0) and (fabs(BHdy)>4.0)) continue;
      ...
      if((fabs(dx)>5.0) && (fabs(dy)>5.0) && (fabs(xe[gem0])>50.0) && (fabs(ye[gem0])>50.0))
      {
