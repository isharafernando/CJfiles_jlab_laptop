...
#,'i9_CJ15',,'ioff9_CJ15','i1_CJ15-3-NoJL','ioff1_CJ15-3-NoJLabData',-3+JLabAC-Wasy, 'i1n_CJ15-JAC-3','i1n_CJ15+JAC-2','i1n_CJ15-3-NoJAC+BONUS'
filenames=['CJ15','i1n_CJ15+JAC-2'];
FileNames=['./Data/'+i for i in filenames]
ALabels=['CJ15 (ref)',"ioff1new_CJ15-3+JLabAC"]
PlotOS=[1,1]
