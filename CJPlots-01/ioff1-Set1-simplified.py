...
#,'i9_CJ15',,'ioff9_CJ15','i1_CJ15-3-NoJL','ioff1_CJ15-3-NoJLabData'
filenames=['CJ15','i1n_CJ15-JAC-2'];
FileNames=['./Data/'+i for i in filenames]
ALabels=['CJ15 (ref)','ioff1new_CJ15-3']
PlotOS=[1,1]
...
#print ioff1definitions.parcov(ParFileNames[2],'off2','off3')
...
def duPlotsNew(TN=2,alignment=1.0):
    ...
    plt.subplot(2,2,2)
    #-1.0,0.6, ,-0.7,0.3
    ioff1definitions.OffShellPlot(PlotOS,Outlists,OutFileNames,Parlists,ParFileNames,filenames,-0.7,0.3,ALabels)
    plt.subplot(2,2,3)
