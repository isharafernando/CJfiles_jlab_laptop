...
centralvaluespath_Mul='./Data/Wreal_Mul_pDn'
centralvaluespath_Add='./Data/Wreal_Add_pDn'


#REMEMBER TO change HTpforSingleX and HTnforSingleX variable names for pDn case
#mainfitlabel='CJ15'
mainfitname_mul='Wreal_Mul_pDn'
mainfitname_add='Wreal_Add_pDn'
...
def HTnforSingleX(x,filename):
    h1n=parametervalue(filename,'ht1n')
    h2n=parametervalue(filename,'ht2n')
    h3n=parametervalue(filename,'ht3n')
    h4n=parametervalue(filename,'ht4n')
...
#plt.xlim(0.5,1.0)
#plt.ylim(0.0,0.25)
#SinglePDFPlotWithBand(CJ15ioffXMul_pdf,2,5,'green','Multiplicative_HT($p \\neq n$)')
#SinglePDFPlotWithBand(CJ15ioffXAdd_pdf,2,5,'orange','Additive_HT($p \\neq n$)')
#plt.ylabel('$d/u$', fontsize=25)
#plt.xlabel('$x$', fontsize=25)
#plt.xticks(fontsize=16)
#plt.yticks(fontsize=16)
#plt.legend(loc=1, fontsize=16,frameon=False, handlelength=3)
#f3.savefig('./Results/yWyLyB/pDn_PDFs.pdf')
#
#
#
#f4=plt.figure(4)
...
#CpTildeCurve(centralvaluespath_Add,mainfitname_add,HTA_F2_P_LT,'5.000','orange','$\\widetilde{C}_{(p)}$(from Additive)')
#CnTildeCurve(centralvaluespath_Add,mainfitname_add,HTA_F2_N_LT,'5.000','green','$\\widetilde{C}_{(n)}$(from Additive)')
...
#f4.savefig('./Results/yWyLyB/pDn_Cs.pdf')
#
#
#
#f6=plt.figure(6)
##plt.suptitle('$H(x) and $\\widetilde{H}(x)$ vs $x$ for $p \\neq n $', fontsize=16)
...
#plt.yticks(fontsize=16)
#plt.legend(loc=2, fontsize=16,frameon=False, handlelength=3)
#f6.savefig('./Results/yWyLyB/pDn_Hs.pdf')
#
#
#
#
...
#OffShellPlot(centralvaluespath_Mul,mainfitname_mul,'green','Multiplicative_HT($p \\neq n$)')
#OffShellPlot(centralvaluespath_Add,mainfitname_add,'orange','Additive_HT($p \\neq n$)')
...
#f9.savefig('./Results/yWyLyB/pDn_OSs.pdf')
#
#
#
#f10=plt.figure(10)
##plt.suptitle('$F_2^D/F_2^N vs $x$', fontsize=16)
#F2Plot(HTM_F2_DN,'5.000','green','Multiplicative_HT($p \\neq n$)')
#F2Plot(HTA_F2_DN,'5.000','orange','Additive_HT($p \\neq n$)')
...
#f10.savefig('./Results/yWyLyB/pDn_F2DNs.pdf')
#

#f11=plt.figure(11)
##plt.suptitle('$F_2^D/F_2^N vs $x$', fontsize=16)
#F2Plot(F2_DN_mul_off,'5.000','green','Multiplicative_HT($p \\neq n$)')
#F2Plot(F2_DN_add_off,'5.000','orange','Additive_HT($p \\neq n$)')
#plotband('./Data/AKP-F2DN-Upper.txt','./Data/AKP-F2DN-Lower.txt','AKP (2017)')
#plt.legend(loc=3, fontsize=16,frameon=False, handlelength=3)
#plt.ylim(0.9,1.07)
#plt.xlim(0.1,0.9)
...
#plt.xlabel("$x$", fontsize=25)
#plt.ylabel("$F_2^D/F_2^N$", fontsize=25)
#f11.savefig('./Results/yWyLyB/pDn_F2DNs_errorbands.pdf')
#
#
#
#f12=plt.figure(12)
#plt.suptitle('$(F_2^D_{on}-F_2^D_{off})/F_2^D_{on}$ vs $x$', fontsize=16)
#F2ComparisonPlot(F2_D_mul_on,F2_D_mul_off,'5.000','green','Multiplicative_HT($p \\neq n$)')
#F2ComparisonPlot(F2_D_add_on,F2_D_add_off,'5.000','orange','Additive_HT($p \\neq n$)')
#plt.legend(loc=3, fontsize=16,frameon=False, handlelength=3)
##plt.ylim(0.9,1.07)
##plt.xlim(0.1,0.9)
#plt.xticks(fontsize=16)
#plt.yticks(fontsize=16)
#plt.xlabel("$x$", fontsize=25)
#plt.ylabel("$F_2^D$", fontsize=25)
#f12.savefig('./Results/yWyLyB/pDn_F2Ds_Off_vs_On.pdf')

#f12=plt.figure(12, figsize=(10, 8))
#plt.suptitle('$F_2^D$((OnShell-OffShell)/OnShell) vs $x$ (Multiplicative HT $p \\neq n$)', fontsize=16)
#F2ComparisonPlot(F2_D_mul_on,F2_D_mul_off,'2.000','yellow','$Q^2=2GeV^2$($p \\neq n$)')
#F2ComparisonPlot(F2_D_mul_on,F2_D_mul_off,'5.000','orange','$Q^2=5GeV^2$($p \\neq n$)')
#F2ComparisonPlot(F2_D_mul_on,F2_D_mul_off,'10.000','red','$Q^2=10GeV^2$($p \\neq n$)')
#F2ComparisonPlot(F2_D_mul_on,F2_D_mul_off,'20.000','darkred','$Q^2=20GeV^2$($p \\neq n$)')
#F2ComparisonPlot(F2_D_mul_on,F2_D_mul_off,'50.000','brown','$Q^2=50GeV^2$($p \\neq n$)')
#F2ComparisonPlot(F2_D_mul_on,F2_D_mul_off,'100.000','black','$Q^2=100GeV^2$($p \\neq n$)')
#plt.legend(loc=3, fontsize=16,frameon=False, handlelength=3)
#plt.ylim(-0.20,0.20)
##plt.xlim(0.1,0.9)
#plt.xticks(fontsize=16)
...
#f12.savefig('./Results/yWyLyB/pDn_F2Ds_Off_vs_On_Mul.pdf')
#
#
#
#f13=plt.figure(13, figsize=(10, 8))
#plt.suptitle('$F_2^D$((OnShell-OffShell)/OnShell) vs $x$ (Additive HT $p \\neq n$)', fontsize=16)
#F2ComparisonPlot(F2_D_add_on,F2_D_add_off,'2.000','greenyellow','$Q^2=2GeV^2$($p \\neq n$)')
#F2ComparisonPlot(F2_D_add_on,F2_D_add_off,'5.000','lawngreen','$Q^2=5GeV^2$($p \\neq n$)')
#F2ComparisonPlot(F2_D_add_on,F2_D_add_off,'10.000','limegreen','$Q^2=10GeV^2$($p \\neq n$)')
#F2ComparisonPlot(F2_D_add_on,F2_D_add_off,'20.000','mediumseagreen','$Q^2=20GeV^2$($p \\neq n$)')
#F2ComparisonPlot(F2_D_add_on,F2_D_add_off,'50.000','green','$Q^2=50GeV^2$($p \\neq n$)')
#F2ComparisonPlot(F2_D_add_on,F2_D_add_off,'100.000','darkgreen','$Q^2=100GeV^2$($p \\neq n$)')
#plt.legend(loc=3, fontsize=16,frameon=False, handlelength=3)
#plt.ylim(-0.20,0.20)
##plt.xlim(0.1,0.9)
#plt.xticks(fontsize=16)
...
#plt.xlabel("$x$", fontsize=25)
#plt.ylabel("$F_2^D$((OnShell-OffShell)/OnShell)", fontsize=25)
#f13.savefig('./Results/yWyLyB/pDn_F2Ds_Off_vs_On_Add.pdf')



#f14=plt.figure(14, figsize=(12, 10))
#plt.suptitle('$F_2^D$((OnShell-OffShell)/OnShell) vs $x$ (Multiplicative HT $p \\neq n$ at fixed x)', fontsize=16)
#F2ComparisonPlotFixedX(F2_D_mul_on,F2_D_mul_off,'.2000E+00','yellow','$x=0.2$($p \\neq n$)')
#F2ComparisonPlotFixedX(F2_D_mul_on,F2_D_mul_off,'.4000E+00','orange','$x=0.4$($p \\neq n$)')
#F2ComparisonPlotFixedX(F2_D_mul_on,F2_D_mul_off,'.6000E+00','red','$x=0.6$($p \\neq n$)')
#F2ComparisonPlotFixedX(F2_D_mul_on,F2_D_mul_off,'.7000E+00','darkred','$x=0.7$($p \\neq n$)')
#F2ComparisonPlotFixedX(F2_D_mul_on,F2_D_mul_off,'.8000E+00','brown','$x=0.8$($p \\neq n$)')
#plt.legend(loc=3, fontsize=16,frameon=False, handlelength=3)
#plt.ylim(-0.05,0.05)
##plt.xlim(0.1,0.9)
#plt.xticks(fontsize=16)
...
#plt.ylabel("$F_2^D$((OnShell-OffShell)/OnShell)", fontsize=25)
#f14.savefig('./Results/pDn_F2Ds_Off_vs_On_Mul_fixd_x.pdf')
#
#
#
#f15=plt.figure(15, figsize=(12, 10))
#plt.suptitle('$F_2^D$((OnShell-OffShell)/OnShell) vs $x$ (Additive HT $p \\neq n$)', fontsize=16)
#F2ComparisonPlotFixedX(F2_D_add_on,F2_D_add_off,'.2000E+00','greenyellow','$x=0.2$($p \\neq n$)')
#F2ComparisonPlotFixedX(F2_D_add_on,F2_D_add_off,'.4000E+00','lawngreen','$x=0.4$($p \\neq n$)')
#F2ComparisonPlotFixedX(F2_D_add_on,F2_D_add_off,'.6000E+00','limegreen','$x=0.6$($p \\neq n$)')
#F2ComparisonPlotFixedX(F2_D_add_on,F2_D_add_off,'.7000E+00','mediumseagreen','$x=0.7$($p \\neq n$)')
#F2ComparisonPlotFixedX(F2_D_add_on,F2_D_add_off,'.8000E+00','green','$x=0.8$($p \\neq n$)')
#plt.legend(loc=3, fontsize=16,frameon=False, handlelength=3)
#plt.ylim(-0.05,0.05)
##plt.xlim(0.1,0.9)
#plt.xticks(fontsize=16)
...
#plt.xlabel("$Q^2$", fontsize=25)
#plt.ylabel("$F_2^D$((OnShell-OffShell)/OnShell)", fontsize=25)
#f15.savefig('./Results/pDn_F2Ds_Off_vs_On_Add_fixd_x.pdf')
...
plt.yticks(fontsize=16)
plt.legend(loc=1, fontsize=16,frameon=False, handlelength=3)
f1.savefig('./Results/pDn_du.pdf')


f2=plt.figure(2)
plt.xlim(0.0,0.8)
plt.ylim(0.8,1.6)
SinglePDFPlotWithBand(CJ15ioffXMul_pdf,2,3,'green','Multiplicative_HT($p \\neq n$)')
SinglePDFPlotWithBand(CJ15ioffXAdd_pdf,2,3,'orange','Additive_HT($p \\neq n$)')
plt.ylabel('$\\bar{d}/\\bar{u}$', fontsize=25)
plt.xlabel('$x$', fontsize=25)
plt.xticks(fontsize=16)
plt.yticks(fontsize=16)
plt.legend(loc=1, fontsize=16,frameon=False, handlelength=3)
f2.savefig('./Results/pDn_dbub.pdf')



f3=plt.figure(3)
F2NP_Plot_FixedQ2(F2_N_mul_off,F2_P_mul_off,'10.000','green','Multiplicative_HT($p \\neq n$)')
F2NP_Plot_FixedQ2(F2_N_add_off,F2_P_add_off,'10.000','orange','Additive_HT($p \\neq n$)')
plt.legend(loc=3, fontsize=16,frameon=False, handlelength=3)
plt.ylim(0.2,0.6)
plt.xlim(0.2,1.0)
plt.xticks(fontsize=16)
...
f3.savefig('./Results/pDn_F2PNs.pdf')
...
plt.xlabel("$x$", fontsize=25)
plt.ylabel("$\delta f$", fontsize=25)
f4.savefig('./Results/pDn_OSs.pdf')
